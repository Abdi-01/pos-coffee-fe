...
function LoginPage() {
    ...
    <Flex mx="auto" mt='0px' maxWidth={'3xl'} maxH='85vh'>
        <Box w='60%' >
            <Image borderLeftRadius='3xl' objectFit='cover' w='full' h={'100%'} src='https://images.unsplash.com/photo-1606791405792-1004f1718d0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80' alt='Coffee' />
        </Box>
        <Box px='8' py='4' backgroundColor={"gray.900"} borderRightRadius='3xl' w="40%">
            <Text fontSize='4xl' fontWeight='bold' color={'white'}>Sign in</Text>
            <FormControl my='5'>
                <FormLabel color={'white'}>Username</FormLabel>
                <Input backgroundColor={'white'} type='email' onChange={(e) => setUsername(e.target.value)} />
            </FormControl>
            <FormControl my='5'>
            ...
            <div style={{ textAlign: 'right' }}>
                <Button type='button' ml='1.5' variant='link' color={"white"}>Forgot password ?</Button>
            </div>
            <Button onClick={onBtnLogin} my='4' width='full' type='button' backgroundColor={"orange.500"} color="white">
                Login
            </Button>
        </Box>
    </Flex>
